...
def generate_pdf_report(scan_response: dict) -> bytes:
    ...
    # -- Header --
    story.append(Paragraph("Litmus Analysis Report", styles["ReportTitle"]))
    ...
    if top_words:
        ...
        story.append(Paragraph(f"<b>Top Words:</b> {words_str}", styles["ReportBody"]))

    # -- Footer --
    story.append(Spacer(1, 24))
    story.append(HRFlowable(width="100%", thickness=0.5, color=MUTED, spaceAfter=6))
    story.append(Paragraph("Generated by Litmus v3.0", styles["FooterStyle"]))
