...
This document describes the technical architecture of Litmus — a dual-axis resume scanner that evaluates ATS keyword compatibility and AI-generated text detection simultaneously.
...
Litmus is the first tool that checks a resume on **two axes simultaneously**:
