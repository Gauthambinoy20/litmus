    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-xs text-muted max-w-xs">
          Your scan history will appear here after you run your first scan. Results are saved
            ...
            <div key={entry.id} className="border-b border-border/50 last:border-0">
              ...
              >
                ...
                <span
                  ...
                  style={{ color: scoreColor(entry.ats_score) }}
                >
                  {Math.round(entry.ats_score)}
                </span>
                <span
                  className="font-mono font-semibold"
                  style={{ color: scoreColor(entry.ai_score, true) }}
                >
                  {Math.round(entry.ai_score)}
                </span>
                <span
                  className="text-[11px] font-medium"
                  style={{ color: readinessColor(entry.readiness_level) }}
                >
                ...
                <div className="px-4 pb-3 space-y-2 animate-in">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-[11px]">
                    ...
                    <div className="bg-surface rounded-lg px-3 py-2">
                      ...
                      <p
                        className="font-mono font-semibold"
                        style={{ color: scoreColor(entry.readiness_score) }}
                      >
