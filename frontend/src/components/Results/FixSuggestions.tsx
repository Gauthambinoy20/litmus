        ...
        {fixes.map((fix, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Priority dot */}
              <div
                className={`mt-1.5 w-1.5 h-1.5 rounded-full shrink-0 ${PRIORITY_DOT[fix.priority]}`}
              />
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-[11px] font-medium ${isDone ? "line-through text-muted" : ""}`}
                  >
                    {fix.title}
                  </span>
                </div>
                <p className="text-[10px] text-muted leading-relaxed mt-0.5 line-clamp-2">
                  {fix.description}
                </p>
