        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-semibold mb-1">
              Your resume scored {aiScore.toFixed(0)} on AI detection
            </h3>
            <p className="text-[11px] text-muted leading-relaxed mb-4">
              Many ATS systems now flag AI-generated content. Humanize your resume to reduce
              detection risk while preserving your qualifications and keywords.
            </p>
            ...
            {state === "error" && error && <p className="mt-3 text-[11px] text-danger">{error}</p>}
          </div>
        </div>
      </div>
    );
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-muted">
              This may take 15-30 seconds. We are rewriting flagged patterns while preserving your
              content.
            </p>
    ...
    <div className="card p-5 border-success/30 animate-in space-y-5">
      ...
      <div className="flex items-center justify-center gap-6 py-3 bg-bg rounded-xl border border-border">
        ...
        <div className="text-center pl-6 border-l border-border">
          ...
          <p className="text-2xl font-bold mono text-success">-{result.improvement.toFixed(0)}</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <div className="bg-bg rounded-xl border border-border p-4 max-h-64 overflow-y-auto">
            <p className="text-[10px] font-semibold text-danger/80 uppercase tracking-wider mb-2">
              Original
            </p>
          ...
          <div className="bg-bg rounded-xl border border-success/20 p-4 max-h-64 overflow-y-auto">
            <p className="text-[10px] font-semibold text-success/80 uppercase tracking-wider mb-2">
              Humanized
            </p>
            <p className="text-[11px] text-text-secondary leading-relaxed whitespace-pre-wrap mono">
