      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        <div>
          ...
          <p className="text-2xl font-bold">
            {data.before.ats_score.overall_score} &rarr; {data.after.ats_score.overall_score}
          </p>
        ...
        <div>
          ...
          <p className="text-2xl font-bold">
            {data.before.ai_score.overall_score.toFixed(0)} &rarr;{" "}
            {data.after.ai_score.overall_score.toFixed(0)}
          </p>
        ...
        <div>
          ...
          <p className="text-2xl font-bold">
            {data.before.combined.interview_readiness_score} &rarr;{" "}
            {data.after.combined.interview_readiness_score}
          </p>
