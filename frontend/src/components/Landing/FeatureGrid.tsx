...
const FEATURES = [
  {
    ...
    desc: "Matches against JD with 100+ alias mappings",
  },
  { icon: Brain, title: "12-signal AI scan", desc: "Detects AI patterns, structure, vocabulary" },
  {
    icon: Wrench,
    title: "Fix suggestions",
    desc: "Prioritized, actionable, with impact estimates",
  },
    ...
    <section id="features" className="py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-3">
          {FEATURES.map((f, i) => (
            <div key={f.title} className={`card p-5 animate-in stagger-${i + 1}`}>
